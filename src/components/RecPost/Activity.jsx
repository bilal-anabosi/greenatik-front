                            ...
                            {likedPosts.map((post, index) => (
                                <tr key={index}>
                                    <td className="align-middle border-top-0 w-0">
                                        <Link to="# "><img src={post.image} alt="Profile" className="icon-shape icon-xl" /></Link>
                                    </td>
                                    ...
                                    <td className="text-muted align-middle border-top-0">
                                        <Link to={`/singlepost/${post.postId}`} className="text-inherit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
